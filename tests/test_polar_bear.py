...
class TestPolarBear(TestCase):
    def test_say(self):
        ...
        target_col = 'target'
        cleaned_train_df, target_df, cleaned_test_df = pb.clean(train_df, test_df, target_col, 0.5)
        ...
        self.assertEqual(len(cleaned_train_df.columns), len(cleaned_test_df.columns))
